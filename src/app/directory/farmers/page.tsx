...
const farmers = [
  {
    ...
    image: '/farmers/farm1.png'
  },
  {
    name: 'Sunrise Dairy',
    location: 'Wisconsin, USA',
    specialty: 'Dairy Products',
    image: '/farmers/farm2.png'
  },
  {
    name: 'Heritage Grains',
    location: 'Montana, USA',
    specialty: 'Organic Grains',
    image: '/farmers/farm3.png'
  },
  {
    name: 'Pacific Coast Fishery',
    location: 'Oregon, USA',
    specialty: 'Sustainable Seafood',
    image: '/farmers/farm4.png'
  }
];
      ...
      <div className="container py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {farmers.map((farmer, index) => (
            <Link
              key={index}
              href={`/farmers/${farmer.name.toLowerCase().replace(/\s+/g, '-')}`}
            ...
            >
              ...
              <div className="flex flex-col gap-2.5">
                ...
                <div>
                  ...
                  <p className="text-sm text-[#354439]/70">
                    {farmer.specialty}
                  </p>
                </div>
              </div>
